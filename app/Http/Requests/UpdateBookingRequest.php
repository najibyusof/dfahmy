...
class UpdateBookingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'booking_reference' => ['required', 'string', 'max:40', Rule::unique('bookings', 'booking_reference')->ignore($booking->id)],
            ...
            'items.*.bookable_unit_id' => ['nullable', 'integer', 'exists:bookable_units,id', 'distinct'],
            'items.*.room_id' => ['nullable', 'integer', 'exists:rooms,id', 'distinct', 'required_without:items.*.bookable_unit_id'],
