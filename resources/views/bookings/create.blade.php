<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-900 leading-tight">New Booking</h2>
    </x-slot>
    ...
    <section class="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form method="GET" action="{{ route('bookings.create') }}" class="mt-3 grid gap-3 md:grid-cols-3">
            <div>
